...
function NotFound() {
  return (
    <main
      id="not-found"
      className="flex justify-center relative w-full h-full bg-white"
    >
      <div
        id="not-found-info "
      ...
      >
        <h1 className="py-4">
          <span className="text-3xl bold text-blue-900 ">
        ...
        <Link href="/" className=" ">
          {" "}
          <button
            className="border-1 py-4 text-3xl text-blue-600 hover:text-blue-800 flex justify-center items-center gap-2"
